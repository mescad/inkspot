...
import testimg from "../../assets/euroink.png"
      ...
      {selectedProduct && (
        <div className="solventcard-modal-overlay" onClick={closeModal}>
          <div className="solventcard-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            {selectedProduct === "EUROFLEX-EXT-HD" && <SubCardDetails productId="solvent-euroflex-ext-hd" productImage={solvent31} title={t.cardTitles.card1} shortDescription={t.cardDescription.card1} pdfRO={EuroflexEXTHD_RO} pdfRU={EuroflexEXTHD_RO} pdfENG={EuroflexEXTHD_RO} descriptionText={t.descriptionText.card1} characteristicsText={t.characteristicsText.card1}
            ...
            {selectedProduct === "EUROFLEX-INT-HD" && <SubCardDetails productId="solvent-euroflex-int-hd" productImage={solvent31} title={t.cardTitles.card2} shortDescription={t.cardDescription.card2} pdfRO={EuroflexINTHD_RO} pdfRU={EuroflexINTHD_RO} pdfENG={EuroflexINTHD_RO} descriptionText={t.descriptionText.card2} characteristicsText={t.characteristicsText.card2}
            ...
            {selectedProduct === "REFLEX" && <SubCardDetails productId="solvent-renflex" productImage={solvent31} title={t.cardTitles.card3} shortDescription={t.cardDescription.card3} pdfRO={EuroflexRenflex_RO} pdfRU={EuroflexRenflex_RO} pdfENG={EuroflexRenflex_RO} descriptionText={t.descriptionText.card3} characteristicsText={t.characteristicsText.card3}
            ...
            {selectedProduct === "2CFLEXO" && <SubCardDetails productId="solvent-2cflexo" productImage={solvent31} title={t.cardTitles.card4} shortDescription={t.cardDescription.card4} pdfRO={Euroflex2C_ENG} pdfRU={Euroflex2C_ENG} pdfENG={Euroflex2C_ENG} descriptionText={t.descriptionText.card4}  characteristicsText={t.characteristicsText.card4}
