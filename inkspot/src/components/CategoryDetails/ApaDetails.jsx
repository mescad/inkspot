...
const ApaDetails = () => {
  ...
  // Get technical details from translations
  const technicalDetails = t.technicalList;
      ...
      {selectedProduct && (
        <div className="solventcard-modal-overlay" onClick={closeModal}>
          <div className="solventcard-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            {selectedProduct === "Eurokraft VHT" && <ApaSubCardDetails productId="apa-eurokraft-vht" productImage={apa31} shortDescription={t.cardDescription.card1} productTitle={t.cardTitles.card1} pdfRO={EurokraftVHT_RO} pdfRU={EurokraftVHT_RO} pdfENG={EurokraftVHT_RO} descriptionText={t.descriptionText.card1} 
            ...
            {selectedProduct === "Eurokraft RT" && <ApaSubCardDetails productId="apa-eurokraft-rt" productImage={apa31} shortDescription={t.cardDescription.card2} productTitle={t.cardTitles.card2} pdfRO={EurokraftRT_RO} pdfRU={EurokraftRT_RO} pdfENG={EurokraftRT_RO} descriptionText={t.descriptionText.card2}
            ...
            {selectedProduct === "Eurokraft FL" && <ApaSubCardDetails productId="apa-eurokraft-fl" productImage={apa31} shortDescription={t.cardDescription.card3} productTitle={t.cardTitles.card3} pdfRO={EurokraftFL_RO} pdfRU={EurokraftFL_RO} pdfENG={EurokraftFL_RO} descriptionText={t.descriptionText.card3}
            ...
            {selectedProduct === "Eurokraft Gloss" && <ApaSubCardDetails productId="apa-eurokraft-gloss" productImage={apa31} shortDescription={t.cardDescription.card4} productTitle={t.cardTitles.card4} pdfRO={EurokraftGloss_RO} pdfRU={EurokraftGloss_RO} pdfENG={EurokraftGloss_RO} descriptionText={t.descriptionText.card4} 
            ...
            {selectedProduct === "Euraqua MAIL" && <ApaSubCardDetails productId="apa-euraqua-mail" productImage={apa31} shortDescription={t.cardDescription.card5} productTitle={t.cardTitles.card5} pdfRO={EuroAquaMAIL_RO} pdfRU={EuroAquaMAIL_RO} pdfENG={EuroAquaMAIL_RO} descriptionText={t.descriptionText.card5}
            ...
            {selectedProduct === "Euraqua SP" && <ApaSubCardDetails productId="apa-euraqua-sp" productImage={apa31} shortDescription={t.cardDescription.card6} productTitle={t.cardTitles.card6} pdfRO={EuroAquaSP_RO} pdfRU={EuroAquaSP_RO} pdfENG={EuroAquaSP_RO} descriptionText={t.descriptionText.card6}
