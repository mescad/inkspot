    ...
    {selectedProduct && ( 
      <div className="solventcard-modal-overlay" onClick={closeModal}>
        <div className="solventcard-modal-content" onClick={(e) => e.stopPropagation()}>
          ...
          param3={t.param3.card1} key3={t.key3.card1} onClose={closeModal} />}
          ...
          param3={t.param3.card2} key3={t.key3.card2} onClose={closeModal} />}
          ...
          param3={t.param3.card3} key3={t.key3.card3} onClose={closeModal} />}
          ...
          param3={t.param3.card4} key3={t.key3.card4} onClose={closeModal} />}
          ...
          param3={t.param3.card5} key3={t.key3.card5} onClose={closeModal} />}
        </div>
      </div>
    )}
  </div>
